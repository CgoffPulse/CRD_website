        ...
        <section className="py-16 md:py-20">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl lg:text-3xl text-gray-700 max-w-5xl mx-auto mb-10 leading-relaxed">
        ...
        <section className="py-16 md:py-20 bg-gray-50">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-black text-xl md:text-2xl leading-relaxed mb-10 max-w-5xl mx-auto">
              ...
              <p className="text-black text-xl md:text-2xl leading-relaxed max-w-5xl mx-auto">
