      ...
      <main className="pt-32 min-h-screen bg-white">
        <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-6xl">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="w-24 h-px bg-black mx-auto mb-8 sm:mb-12 relative">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-900 text-lg sm:text-xl md:text-2xl leading-relaxed mb-6 sm:mb-8 font-semibold">
              Buying. Selling. Leasing.
            </p>
            <p className="text-gray-700 text-base sm:text-lg md:text-2xl leading-relaxed mb-8 sm:mb-10">
        ...
        <div className="bg-gray-50 py-12 sm:py-16 border-y border-gray-200">
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <blockquote className="text-black text-base sm:text-lg md:text-2xl font-semibold leading-relaxed mb-4 sm:mb-6 text-center italic px-2">
