...
Is             <div className="w-24 h-px bg-black mx-auto mb-12 relative">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-900 text-xl md:text-2xl leading-relaxed mb-8 font-semibold">
        ...
        <div className="bg-gray-50 py-16 border-y border-gray-200">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <blockquote className="text-black text-xl md:text-2xl font-semibold leading-relaxed mb-6 text-center italic">
