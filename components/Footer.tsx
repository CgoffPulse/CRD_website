export default function Footer() {
  return (
    <footer className="bg-black border-t border-gray-800 py-8 md:py-10">
      <div className="container mx-auto px-6 max-w-7xl">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-6">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg md:text-xl font-bold mb-3">CRD Real Estate & Development</h3>
          ...
          {/* Commercial & Development Social - Stacked */}
          <div className="space-y-4">
            {/* Commercial Branch Social */}
            <div>
              <h4 className="text-white text-base font-bold mb-2">Commercial</h4>
              <div className="flex space-x-3">
                <a
                  ...
                  aria-label="Commercial Branch Instagram"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                  aria-label="Commercial Branch Facebook"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
            ...
            {/* Development Social */}
            <div>
              <h4 className="text-white text-base font-bold mb-2">Development</h4>
              <div className="flex space-x-3">
                <a
                  href="https://instagram.com/crddevelopment"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                  aria-label="Development Branch Instagram"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="https://facebook.com/crddevelopment"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                  aria-label="Development Branch Facebook"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
          ...
          {/* Residential Social */}
          <div>
            <h4 className="text-white text-base font-bold mb-2">Residential</h4>
            <div className="flex space-x-3">
              <a
        ...
        <div className="border-t border-gray-800 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-gray-400 text-xs md:text-sm">
